            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="/" class="waves-effect">
                        ...
                        <span key="t-chat">@lang('translation.Dashboards')</span>
                    </a>
                </li>
                <!--Data Dasar-->
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="bio-dosen" key="t-default">Biodata Dosen</a></li>
                        <li><a href="dashboard-saas" key="t-saas">Perubahan Data Dosen</a></li>
                        <li><a href="bio-dosen" key="t-crypto">Kelengkapan Biodata</a></li>
