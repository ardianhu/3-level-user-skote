            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="/" class="waves-effect">
                        ...
                        <span key="t-chat"><?php echo app('translator')->get('translation.Dashboards'); ?></span>
                    </a>
                </li>
                <!--Data Dasar-->
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="dashboard-blog" key="t-blog">Riwayat Penunjang Dosen</a></li>
                    </ul>
                </li>
                <!--PAK-->
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-book-content"></i><span class="badge rounded-pill bg-info float-end"><!--04--></span>
                        <span key="t-dashboards">PAK</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="index" key="t-default">Biodata Dosen</a></li>
                        <li><a href="dashboard-saas" key="t-saas">Perubahan Data Dosen</a></li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-printer"></i><span class="badge rounded-pill bg-info float-end"><!--04--></span>
                        <span key="t-dashboards">Cetak</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="index" key="t-default">Biodata Dosen</a></li>
                        <li><a href="dashboard-saas" key="t-saas">Perubahan Data Dosen</a></li>
...
<!-- Left Sidebar End -->
<?php /**PATH C:\laragon\www\3-level-user-skote\resources\views/layouts/operatorsidebar.blade.php ENDPATH**/ ?>