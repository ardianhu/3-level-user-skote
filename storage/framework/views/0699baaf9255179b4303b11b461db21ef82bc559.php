...
unset($__errorArgs, $__bag); ?>" /*value="<?php echo e(old('email', 'admin@themesbrand.com')); ?>" */ id="username" placeholder="Masukkan Email" autocomplete="email" autofocus>
...
unset($__errorArgs, $__bag); ?>" id="userpassword" /*value="123456" */ placeholder="Masukkan password" aria-label="Password" aria-describedby="password-addon">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <a href="<?php echo e(route('password.request')); ?>" class="text-muted"><i class="mdi mdi-lock me-1"></i> Lupa password?</a>
                                        <?php endif; ?>
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            ...
                            <p>© <script>
                                ...
                                </script> Garuda Cyber Indonesia. Develop by Garuda Cyber Indonesia
                            </p>
                        </div>
                    </div>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\3-level-user-skote\resources\views/auth/login.blade.php ENDPATH**/ ?>