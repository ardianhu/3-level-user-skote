...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Data User'); ?>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" class="mb-3 btn btn-success waves-effect waves-light" data-bs-toggle="modal"
                        data-bs-target="#exampleModalScrollable">Tambahkan Data</button>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" class="form-horizontal" action="/daftar-user"
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('dob')); ?>" data-provide="datepicker" name="dob"
                                                    autofocus required>
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-select text-capitalize" name="role_id">
                                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($role->id); ?>" class="text-capitalize">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?php echo e($user->avatar); ?>" class="rounded-circle object-fit-cover"
                                                style="width: 30px; height: 30px;">
                                        </td>
                                        <td>

                                            <a href="" class="btn btn-primary waves-effect waves-light"
                                                data-bs-toggle="modal" data-bs-target=".update-profile">Edit</a>

                                            <!-- center modal -->
                                            <button type="button" class="btn btn-danger waves-effect waves-light"
                                                data-bs-toggle="modal"
                                                data-bs-target="#deleteModal<?php echo e($user->id); ?>">Delete</button>

                                            <div id="deleteModal<?php echo e($user->id); ?>"
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\3-level-user-skote\resources\views/admin/show.blade.php ENDPATH**/ ?>